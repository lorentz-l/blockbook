...
func (b *TronRPC) fetchContractInfo(address string) (*bchain.ContractInfo, error) {
...
func (b *TronRPC) EthereumTypeGetErc20ContractBalance(addrDesc, contractDesc bchain.AddressDescriptor) (*big.Int, error) {
...
func (b *TronRPC) GetTokenURI(contractDesc bchain.AddressDescriptor, tokenID *big.Int) (string, error) {
