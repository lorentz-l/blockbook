...
func (b *TronRPC) initStakingPools(coinShortcut string) error {
...
func (b *TronRPC) EthereumTypeGetSupportedStakingPools() []string {
	return b.supportedStakingPools
}

func (b *TronRPC) EthereumTypeGetStakingPoolsData(addrDesc bchain.AddressDescriptor) ([]bchain.StakingPoolData, error) {
...
func (b *TronRPC) everstakeBalanceTypeContractCall(signature, addr, contract string) (string, error) {
...
func (b *TronRPC) everstakeContractCallSimpleNumeric(signature, addr, contract string) (*big.Int, error) {
...
func (b *TronRPC) everstakePoolData(addr, contract, name string) (*bchain.StakingPoolData, error) {
